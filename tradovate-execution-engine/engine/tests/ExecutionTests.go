...
// func testDailyLossLimit(symbol string, log *logger.Logger) {
// 	// Create a new order manager with a low loss limit
// 	lowLimitConfig := execution.NewConfig(1, 50.0) // $50 loss limit
// 	testOM := execution.NewOrderManager(lowLimitConfig, log)
